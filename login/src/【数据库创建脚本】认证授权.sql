...
DROP DATABASE IF EXISTS yootk_authorization;
CREATE DATABASE yootk_authorization CHARACTER SET UTF8 ;
USE yootk_authorization ;
...
--------------------------------------------------------
DROP DATABASE IF EXISTS yootk_logbook;
CREATE DATABASE yootk_logbook CHARACTER SET UTF8 ;
USE yootk_logbook ;
